...
namespace Mem.Plugin.Web.Infrastructure
{
    /// <summary>
    /// A class that finds types needed by Mem by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        /// <summary>Gets or sets wether Mem should iterate assemblies in the app domain when loading Mem types. Loading patterns are applied when loading these assemblies.</summary>
        ...
        /// <remarks>If you change this so that Mem assemblies arn't investigated (e.g. by not including something like "^Mem|..." you may break core functionality.</remarks>
        ...
        /// <returns>A list of assemblies that should be loaded by the Mem factory.</returns>
        ...
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into Mem.
        /// </returns>
