...
(function ($) {
    ...
    $.fn.wBox = function (options) {
        var defaults = {
            wBoxURL: "http://www.ccnf.com/Include/js/wbox/",
            opacity: 0.5, //背景透明度
            callBack: null,
            noTitle: false,
            show: false,
...
//                        })
        ...
        */
        function setPosition() {
            ...
            var $h = $("body").height(), $wh = $win.height(), $hh = $("html").height(), $hhh = document.body.scrollHeight;
...
jQuery.CCNFBox = {
    confirm: function (text, okBack) {
        $().wBox
        ({
            show: true,
            title: "提示",
            html: "<div class='Coordinate'><p class='text'>" + text + "</p><p><input id='btnwBoxOk' class='input_ok'  type='button' value='确 定'><input name=''  type='button' class='wBox_close' value='取 消'></p></div>",
            callBack: function () {
                $("#btnwBoxOk").click(okBack);
            }
        });
    ...
    alert: function (text) {
        ...
        ({
            show: true,
            title: "提示",
            html: "<div class='Coordinate'><p class='text'>" + text + "</p><p><input id='btnwBoxOk' class='input_ok wBox_close'  type='button' value='确 定'></p></div>"
        });
    },
    alertGo: function (text, url) {
        $().wBox
        ({
            show: true,
            title: "提示",
            html: "<div class='Coordinate'><p class='text'>" + text + "</p><p><input id='btnwBoxOk' class='input_ok wBox_close'  type='button' value='确 定'></p></div>",
            callBack: function () {
                $("#btnwBoxOk").click(function () {
                    location.href = url;
                });
            }
        });
    },
    alertCallBack: function (text, okBack) {
        $().wBox
        ({
            show: true,
            title: "提示",
