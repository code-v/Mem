        ...
        CCNFMap: function (e) {
            ...
            $dragMap.dblclick(function (e) {
                ...
                function confirmPos() {
                    ...
                    $.ajax({
                        type: "post",
                        url: "/BinTouch/UpdateBinTouchMap", //---修改成手机接口:路径，参数:MapXY,bintouchid
                        datatype: "json",
                        data: { MapXY: $hideObject.val(), bintouchConfigureID: $hideObject.attr("bintouchconfigureid") },
                        beforeSend: function () {
                            //alert(bintouchConfigureID);
                        },
            ...
            $dragMap.mousedown(function (e) {
                ...
                $dragMapContainer.mousemove(function (e2) {
                    ...
                    var moveObjX = moveObj.position().left - moveX; //移动后计算的x坐标
                    var moveObjY = moveObj.position().top - moveY; //移动后计算的y坐标
